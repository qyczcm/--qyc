...
function [Pos_out,f] = forwardKinematics111(theta1,theta2,theta3)
e = 0.65;%e = param(1); %end effector frame末端执行器架
f = 0.185;%f = param(2); %base frame
rf = 0.16;%rf = param(4); %base arm 大腿
re = 0.55;%re = param(3); %parallelogram 平行四边形
